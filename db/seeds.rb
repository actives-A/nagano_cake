...
# ユーザーを10人生成
(1..10).each do |i|
    user=Customer.new(email: "test#{i+1000}"+"@"+"gmail.com",password: 'aaaaaa', first_name: "太郎#{i}",last_name: "山田#{i}",kana_first_name: "タロウ#{i}",
    kana_last_name: "ヤマダ#{i}",postal_code: "500-1111",phone_namber: "090-8888-8888",address: "東京都千代田区千代田１−１#{i}")
    user.save!
end
